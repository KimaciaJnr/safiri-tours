...
import { ArrowRight, Car, MapPinned, Plane, ShieldCheck, Trees, Users } from 'lucide-react';

const destinations = [
  {
    title: 'Masai Mara',
    description:
      'Kenya’s iconic wildlife destination, famous for big cats, abundant wildlife, and the Great Migration.',
  },
  {
    title: 'Amboseli',
    description:
      'Known for large elephant herds and stunning views of Mount Kilimanjaro.',
  },
  {
    title: 'Tsavo',
    description:
      'A vast wilderness offering diverse wildlife, dramatic landscapes, and its famous red elephants.',
  },
  {
    title: 'Lake Nakuru',
    description:
      'A great choice for birdlife, flamingos, rhinos, and scenic surroundings.',
  },
  {
    title: 'Samburu',
    description:
      'Offers a unique northern Kenya experience with wildlife such as Grevy’s zebra and reticulated giraffes.',
  },
];
...
const safariTypes = [
  {
    title: 'Day Trips',
    description:
      'Perfect for travelers short on time, with Nairobi National Park providing an easy wildlife escape close to the city.',
    icon: <MapPinned className="h-5 w-5 text-[#C96A2B]" />,
  },
  {
    title: '2–4 Day Safaris',
    description:
      'Ideal for destinations such as Amboseli and Lake Nakuru, offering a quick but memorable journey into the wild.',
    icon: <Trees className="h-5 w-5 text-[#C96A2B]" />,
  },
  {
    title: 'Longer Itineraries',
    description:
      'Multi-stop journeys allow travelers to combine several parks for a richer, more diverse safari experience.',
    icon: <Users className="h-5 w-5 text-[#C96A2B]" />,
  },
];
...
const safariPackages = [
  ...
  {
    title: '13 Days Nairobi, Masai Mara, Hell’s Gate, Amboseli, Taita Hills & Diani',
...
export default function KenyaSafarisFromNairobi() {
  return (
    <section id="kenya-safaris-from-nairobi" className="bg-[#FAF8F5] py-20 px-6 text-gray-800">
      <div className="mx-auto max-w-7xl space-y-12">
        <header className="overflow-hidden rounded-[2rem] border border-[#E7DDD0] bg-white shadow-[0_18px_45px_rgba(17,24,39,0.04)]">
          <div className="grid md:grid-cols-[1.15fr_0.85fr]">
            <div className="p-8 md:p-12">
              <span className="text-xs font-semibold tracking-[0.22em] text-[#C96A2B] uppercase">Kenya Safaris</span>
              <h1 className="mt-4 text-3xl font-bold leading-tight text-[#1E2928] md:text-5xl">Kenya Safaris from Nairobi</h1>
        ...
        <section className="rounded-[2rem] border border-[#E7DDD0] bg-white p-6 md:p-8 shadow-sm">
          <div className="space-y-6">
            <div className="max-w-4xl space-y-4">
              <p className="text-lg leading-relaxed text-gray-700">
                <span className="font-semibold text-[#0F5B5B]">Where You Can Go:</span> From Nairobi, you can explore a variety of destinations, each offering a different safari experience:
              </p>
