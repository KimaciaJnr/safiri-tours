      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex justify-center">
          <div className="relative w-full max-w-md">
            ...
            <div className="absolute bottom-6 right-2 sm:-right-6 bg-[#2D6A6A] text-white p-5 rounded-2xl max-w-xs shadow-xl">
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
            We don't sell itineraries. <span className="text-[#2D6A6A] italic font-serif">We create experiences.</span>
          </h2>
          ...
          <div className="space-y-4 pt-2">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-full bg-[#2D6A6A]/10 text-[#2D6A6A]">
          ...
          <a
            href="#about"
            className="inline-flex items-center gap-2 text-[#E8732A] font-semibold text-sm hover:gap-3 transition-all pt-2"
          >
