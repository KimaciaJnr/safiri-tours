...
export default function WhatWeOffer() {
  const offers = [
    {
      icon: <Compass className="w-5 h-5 text-[#C96A2B]" />,
      bg: "bg-[#C96A2B]/10",
    ...
    {
      icon: <MapPin className="w-5 h-5 text-[#0F5B5B]" />,
      bg: "bg-[#0F5B5B]/10",
    ...
    {
      icon: <Users className="w-5 h-5 text-[#C96A2B]" />,
      bg: "bg-[#C96A2B]/10",
    ...
    {
      icon: <CheckCircle2 className="w-5 h-5 text-[#0F5B5B]" />,
      bg: "bg-[#0F5B5B]/10",
  ...
  return (
    <section id="safari-guide" className="bg-[#F7F1E5] py-20 px-6">
      <div className="max-w-6xl mx-auto text-center space-y-4">
        <span className="text-xs font-semibold tracking-wider text-[#0F5B5B] uppercase">
          SAFARI GUIDE
        </span>

        <h2 className="text-3xl md:text-5xl font-bold text-[#1E2928] leading-tight">
          Adventures built around <span className="text-[#C96A2B] italic font-serif">the people</span>
        </h2>
