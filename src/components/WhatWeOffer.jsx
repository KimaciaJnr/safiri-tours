...
export default function WhatWeOffer() {
  const offers = [
    {
      icon: <Compass className="w-5 h-5 text-[#E8732A]" />,
      bg: "bg-[#E8732A]/10",
    ...
    {
      icon: <MapPin className="w-5 h-5 text-[#2D6A6A]" />,
      bg: "bg-[#2D6A6A]/10",
    ...
    {
      icon: <CheckCircle2 className="w-5 h-5 text-[#2D6A6A]" />,
      bg: "bg-[#2D6A6A]/10",
  ...
  return (
    <section id="safari-guide" className="bg-[#FAF8F5] py-20 px-6">
      <div className="max-w-6xl mx-auto text-center space-y-4">
        <span className="text-xs font-semibold tracking-wider text-[#2D6A6A] uppercase">
          SAFARI GUIDE
        </span>

        <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
          Adventures built around <span className="text-[#E8732A] italic font-serif">the people</span>
        </h2>
