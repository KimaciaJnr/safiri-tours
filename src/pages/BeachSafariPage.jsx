      ...
      <main id="main" tabIndex={-1} className="max-w-6xl mx-auto px-6 py-16">
        <header className="mb-12 overflow-hidden rounded-[2rem] border border-line bg-white shadow-[0_18px_45px_rgba(17,24,39,0.04)]">
          <div className="grid md:grid-cols-[1.15fr_0.85fr]">
            <div className="p-8 md:p-12">
              <span className="text-xs font-semibold tracking-[0.22em] text-brand-terracotta uppercase">Beach & safari</span>
              <h1 className="mt-4 text-4xl md:text-6xl font-bold leading-tight text-ink">Beach & Safari</h1>
              ...
              <div className="mt-8 flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-teal">Wild moments, coastal calm, unforgettable balance</span>
              </div>
            </div>
        ...
        <section className="grid gap-6 md:grid-cols-2 mb-12">
          <div className="rounded-[2rem] border border-cream-sand bg-white p-8 shadow-sm">
            <h2 className="text-2xl md:text-3xl font-bold text-ink mb-4">Iconic safari parks and reserves</h2>
          ...
          <div className="rounded-[2rem] border border-cream-sand bg-white p-8 shadow-sm">
            <h2 className="text-2xl md:text-3xl font-bold text-ink mb-4">Relaxation on Kenya’s beaches</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-ink mb-6">Featured beach & safari packages</h2>
